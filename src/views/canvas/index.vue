<template>
  <div class="home" style="margin:1vw;">
    ...
    <div style="width:100%;height:200px;border:1px solid red;">
      <canvas id="canvas" style="border:1px solid yellow;"></canvas>
...
<script>
  ...
  recorder.onprogress = function(params) {
    ...
    // console.log('--------------END---------------')
    console.log(params, 'onprogress', params.data)
  }
  export default {
    name: 'Canvas',
    data () {
    ...
    methods: {
      ...
      */
      ...
      drawRecord () {
        ...
        console.log(this.drawRecordId, 'drawRecordId')
        // 实时获取音频大小数据
        let dataArray = recorder.getRecordAnalyseData(),
            bufferLength = dataArray.length;
        console.log(dataArray, 'drawRecord')
        // 填充背景色
